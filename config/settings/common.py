# -*- coding: utf-8 -*-
"""
Django settings for tuticfruti_blog project.
...
APPS_DIR = ROOT_DIR.path('tuticfruti_blog')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'tuticfruti_blog.contrib.sites.migrations'
}
...
ADMINS = (
    ("""tuticfruti""", 'tuticfruti@gmail.com'),
)
...
DATABASES = {
    ...
    'default': env.db("DATABASE_URL", default="postgres:///tuticfruti_blog"),
}
